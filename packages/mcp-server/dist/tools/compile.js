import { compileContracts, analyzeSecurityPatterns, estimateGas, checkSize, } from "@mpc-se2/core";
export const compileContractsTool = {
    name: "compile_contracts",
    description: "Compile Solidity contracts using solc. Automatically resolves OpenZeppelin v5 imports. Returns ABI, bytecode, errors, and warnings.",
    inputSchema: {
        type: "object",
        properties: {
            contracts: {
...
export const checkSecurityTool = {
    name: "check_security",
    description: "Run security pattern analysis and gas estimation on Solidity contracts. Checks for reentrancy, unchecked calls, tx.origin, etc.",
    inputSchema: {
        type: "object",
        properties: {
            contracts: {
